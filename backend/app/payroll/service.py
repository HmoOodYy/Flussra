...
# shared by four domains that all still live in this module — Draft-line CRUD,
# Period Pay Lines, Bonus, and Day Grid — none of which is more entitled to
# own either helper than the others. They represent different
...
# Finalization, Calculation, Period Pay Lines, Bonus, Drivers Off, and Day
# Grid, none of which move in this unit. app.payroll.off_drivers also
